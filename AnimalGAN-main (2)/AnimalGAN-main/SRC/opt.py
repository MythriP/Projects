...
def parse_opt():
    ...
    parser.add_argument("--data_path", type=str, default='./Data/Data_training.tsv',
                        help="path to file that stores all the training data")
    parser.add_argument("--descriptors_path", type=str, default='./Data/MolecularDescriptors.tsv',
    ...
    parser.add_argument("--results_path", type=str, default='./Results', help="Path to save the generated data")
